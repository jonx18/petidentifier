...
def show_example(image_path, container):
    with container:
...
with examples:
    ...
    examples_images = ['./new_sol.jpg', './new_nexus.jpeg', './new_nexus_jony.jpeg']
    for example in range(len(examples_images)):
        show_example(examples_images[example], examples_containers[example])
